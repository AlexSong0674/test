...
**StampGo** — GPS 기반으로 여행지를 방문하면 자동으로 인증 배지를 획득하는 게이미피케이션 여행 앱.  
...
| Phase | 기간 | 목표 | 수익 |
|-------|------|------|------|
| 1 | 0~6개월 | MAU 10,000 | 없음 (사용자 확보) |
| 2 | 6~12개월 | 구독 전환율 5% | 구독 월 2,900원 / 연 24,900원 |
| 3 | 12~24개월 | MRR 500만 원 | 굿즈 + B2B 관광청 협업 |
...
- [ ] App Store 출시를 위한 경로 결정 (FlutterFlow vs React Native vs Flutter)
- [ ] Apple Developer 계정 등록 ($99/년)
- [ ] Supabase 프로젝트 생성 및 DB 스키마 구현
- [ ] 카카오맵 API 키 발급
- [ ] 배지 디자인 제작 (Canva 또는 외주)
- [ ] 경쟁사 분석 추가 (기획서 보완)
- [ ] 단위 경제 (CAC / LTV) 수치 추가
- [ ] 팀 구성 및 실행 로드맵 작성
